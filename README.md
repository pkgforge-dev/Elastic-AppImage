...
* [Latest Stable Release](https://github.com/pkgforge-dev/Elastic-AppImage/releases/latest)
...
* [AM](https://github.com/ivan-hc/AM) `am -i elastic` or `appman -i elastic`

* [dbin](https://github.com/xplshn/dbin) `dbin install elastic.appimage`

* [soar](https://github.com/pkgforge/soar) `soar install elastic`
